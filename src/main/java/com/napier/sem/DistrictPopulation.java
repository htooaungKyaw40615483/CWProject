...
public class DistrictPopulation {
    ...
    public static ArrayList<Population> returnPopulation(String districtName, Connection con){
        ...
        try{
            ...
            */
            String sqlQueryDistrictPopulation = "SELECT country.Region, SUM(country.Population) AS Region_Population,\n" +
                    ...
                    "country.Code = city.CountryCode WHERE country.Region = \"" + districtName +"\" GROUP BY country.Region";
