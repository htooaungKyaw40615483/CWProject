...
public class Top10CapitalCitiesInWorld {
    /**
     * Return a top 10 populated capital cities from the world database
    ...
    public static ArrayList<Capital> returnCapital(Connection con) {
        try {
            ...
            */
            ...
            String sqlQueryTop10CapitalCityInWorld = "SELECT city.Name, country.Name , city.Population FROM city\n" +
                    "JOIN country ON city.ID = country.Capital\n" +
                    "ORDER BY city.Population DESC LIMIT 10;";

            // Storing the results in a ResultSet object, top10capitalCityInWorldResult
            ResultSet top10capitalCityInWorldResult = stmt.executeQuery(sqlQueryTop10CapitalCityInWorld);
            ...
            while (top10capitalCityInWorldResult.next()) {
                ...
                capital.setCapitalName(top10capitalCityInWorldResult.getString(1));
                capital.setCountry(top10capitalCityInWorldResult.getString(2));
                capital.setCapitalPopulation(top10capitalCityInWorldResult.getInt(3));
    ...
    /**
     * Printing a population of top 10 capital cities  in the world from the world database
