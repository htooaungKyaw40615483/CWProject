...
public class Top5CountriesInContinent {
    /**
    ...
    public static ArrayList<Country> ReturnCountries(String ctn, Connection con){
        try{
            ...
            */
            ...
            String sqlQueryCountryInWorld = "SELECT country.Code, country.Name, country.Continent, country.Region, country.Population, city.Name FROM `country`" +
                    ...
                    "WHERE country.Continent = \"" + ctn + "\" ORDER BY country.Population DESC LIMIT 5;";
        ...
        */
            ...
            System.out.println("Failed to get top 5 countries population by continent name in the world");
            return null;
        }
    }
    /**
    ...
    public static void printResult(String ctn, ArrayList<Country> countries){
        System.out.println("---------------------------------------------------Top 5 Countries in the Continent By Largest Population To Smallest-------------------------------------------------------------");
