...
public class Top5CountriesInRegion {
    /**
    ...
    public static ArrayList<Country> ReturnCountries(String rn, Connection con){
        try{
            ...
            */
            String sqlQueryCountryInWorld = "SELECT country.Code, country.Name, country.Continent, country.Region, country.Population, city.Name " +
                    ...
                    "WHERE country.Region = \"" + rn + "\" ORDER BY country.Population DESC LIMIT 5;;";
        ...
        */
            ...
            System.out.println("Failed to get Top 5 countries population by region name in the world");
            return null;
        }
    }
    ...
    public static void printResult(String rn, ArrayList<Country> countries){
        System.out.println("---------------------------------------------------Top 5 Countries in the Region By Largest Population To Smallest----------------------------------------------------------------");
