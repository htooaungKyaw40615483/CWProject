...
public class Top10CountriesInRegionIntegrationTest {

    private static Top10CountriesInRegion t10cir;
    ...
    public static void setUp() {
        ...
        try {
            ...
            // Create an instance of Top10CountriesInRegion to be tested
            t10cir = new Top10CountriesInRegion();
    ...
    @Test
    void testReturnCountriesInRegion() {
        // Fetch the top 10 populated countries in a specific region (e.g., Southern Europe)
        ArrayList<Country> countries = Top10CountriesInRegion.returnCountries("Southern Europe", con);
    ...
    @Test
    void testReturnCountriesInEmptyRegion() {
        ...
        // Fetch the top 10 populated countries in an empty region
        ArrayList<Country> countries = Top10CountriesInRegion.returnCountries("EmptyRegion", emptyCon);
    ...
    void testReturnCountriesWithNullConnection() {
        ...
        ArrayList<Country> countries = Top10CountriesInRegion.returnCountries("Southern Europe", null);
