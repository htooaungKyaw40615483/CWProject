...
public class PopulationPercentInRegionIntegrationTest {
    private static PopulationPercentInRegion PPIR;
    ...
    public static void setUp() {
        ...
        try {
            ...
            // Create an instance of PopulationPercentInRegion to be tested
            PPIR = new PopulationPercentInRegion();
    ...
    void testReturnPopulation() {
        // Fetch all Population in the region
    ...
    @Test
    void testPrintResultForPopulationPercentInRegion() {
        // Fetch all Population Percent in the region
        ArrayList<Population> populations = PopulationPercentInRegion.returnPopulation(con);

        // Call printResult method and check if it executes without any errors
        try {
            PopulationPercentInRegion.printResult(populations);
        } catch (Exception e) {
