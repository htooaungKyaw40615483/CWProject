...
public class WorldPopulationTest {
    ...
    {
        // will throw java.lang.NullPointerException if the null is not checked in WorldPopulation.
        WP.printResult(null);
    }

    @Test
    void returnPopulationTestNull(){
        WP.returnPopulation(null);
    }
    @Test
